...
@pytest.mark.django_db()
def test_03_task_doc_create_with_right_file_type(user_client,
                                                 create_task):
...
@pytest.mark.django_db()
def test_04_task_doc_delete_file_with_object(user_client,
                                             create_task):
    doc_file = create_text_file('testfile')
    task = create_task
    data = {'doc_file': doc_file}
...
@pytest.mark.django_db()
def test_05_task_doc_update_change_uploaded_file(user_client,
                                                 create_task):
    doc_file = create_text_file('testfile')
    task = create_task
    data = {'doc_file': doc_file}
...
@pytest.mark.django_db()
def test_10_comment_doc_create_with_right_file_type(user_client,
                                                    create_comment):
    doc_file = create_text_file('testfile')
    task, comment = create_comment
    data = {'doc_file': doc_file}
...
@pytest.mark.django_db()
def test_11_comment_doc_delete_file_with_object(user_client,
                                                create_comment):
    doc_file = create_text_file('testfile')
    task, comment = create_comment
    data = {'doc_file': doc_file}
...
@pytest.mark.django_db()
def test_12_comment_doc_update_change_uploaded_file(user_client,
                                                    create_comment):
    doc_file = create_text_file('testfile')
    task, comment = create_comment
    data = {'doc_file': doc_file}
...
@pytest.mark.django_db()
def test_13_comment_doc_create_with_wrong_file_type(user_client,
                                                    create_comment):
    image = create_image_file('small')
    task, comment = create_comment
    data = {'doc_file': image}
