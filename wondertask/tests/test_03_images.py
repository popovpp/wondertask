...
@pytest.mark.django_db()
def test_03_task_image_create_with_right_file_type(user_client,
                                                   create_task):
...
@pytest.mark.django_db()
def test_05_task_image_update_change_uploaded_file(user_client,
                                                   create_task):
    image = create_image_file('small')
    task = create_task
    data = {'image_file': image}
...
@pytest.mark.django_db()
def test_10_comment_image_create_with_right_file_type(user_client,
                                                      create_comment):
    image = create_image_file('small')
    task, comment = create_comment
    data = {'image_file': image}
...
@pytest.mark.django_db()
def test_12_task_image_update_change_uploaded_file(user_client,
                                                   create_comment):
    image = create_image_file('small')
    task, comment = create_comment
    data = {'image_file': image}
...
@pytest.mark.django_db()
def test_13_comment_image_create_with_wrong_file_type(user_client,
                                                      create_comment):
